...
| Grades, KHS, GPA, transcript | PARTIAL | 92% | Ya | Ya | GradeCalculator + workflow | Role/service guard | Tabler approval/publish/lock | KHS + bilingual printable transcript | Tabler scheme/component/submit | Tidak | Ya | Hanya published/locked masuk record; configurable BEST_GRADE/LATEST/ALL_ATTEMPTS tersedia. Revisi nilai terkunci kini memiliki request/approve/reject UI dan audit; API serta persistent document/QR verification masih berikutnya. |
