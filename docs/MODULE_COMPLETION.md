...
| Student portal | PARTIAL | 75% | Core academic/finance/LMS | Ya | Academic record/attendance/learning communication | Role/KRS guard | N/A | Tabler dashboard/KRS/KHS/invoice/attendance/LMS/CBT/discussion | N/A | Read API | Ya | Halaman aktif sudah native Tabler; attendance, materi, assignment, CBT, pengumuman, dan forum diskusi tersedia; leave/thesis belum tersedia. |
