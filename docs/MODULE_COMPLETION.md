...
| Lecturer portal | PARTIAL | 62% | Core lecturer/class | Ya | Workspace/attendance | Role guard | N/A | N/A | Tabler dashboard/schedule/classes/advisees/attendance | Lecturer API | Ya | Presensi manual/PIN/QR-token dan koreksi tersedia; grade/LMS/KRS approval/thesis belum tersedia. |
...
| Grades, KHS, GPA, transcript | PARTIAL | 78% | Ya | Ya | GradeCalculator + workflow | Role/service guard | Sebagian | Ya | Read only | Tidak | Ya | Component score, exact weight, submit/approve/publish/lock, controlled revision, IPS/IPK tersedia; Tabler entry/approval dan PDF/QR masih berikutnya. |
