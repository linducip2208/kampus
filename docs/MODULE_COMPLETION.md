...
| Student portal | PARTIAL | 72% | Core academic/finance | Ya | Academic record/attendance/quiz | Role guard | N/A | Tabler dashboard/KRS/KHS/invoice/attendance/LMS/CBT | N/A | Read API | Ya | Halaman aktif sudah native Tabler; attendance, KRS-scoped learning, assignment submission, dan Quiz/CBT dengan timer serta auto-grading tersedia; leave/thesis belum tersedia. |
| Lecturer portal | PARTIAL | 75% | Core lecturer/class | Ya | Workspace/attendance | Role guard | N/A | N/A | Tabler dashboard/schedule/classes/advisees/attendance | Lecturer API | Ya | Presensi manual/PIN/QR-token dan koreksi tersedia; grade dan LMS authoring/grading tersedia; KRS approval/quiz/thesis belum tersedia. |
...
| LMS & assignment | PARTIAL | 75% | Ya | Ya | Submission service | Global | Assignment CRUD | Belum penuh | Belum penuh | Tidak | Ya | Student workspace hanya membuka published content dari kelas KRS; assignment attempt limit, graded lock, resubmit, dan audit tersedia. Lecturer module/content/assignment authoring dan submission grading lock tersedia. Announcement, discussion, lifecycle edit/publish, dan private file policy belum lengkap. |
| Quiz / CBT | PARTIAL | 75% | Ya | Ya | QuizAttemptService | Role/KRS ownership guard | Belum penuh | Tabler attempt/timer/navigation/result | Belum penuh | Tidak | Ya | Student CBT mendukung stable randomized question/option order, server-side expiry, attempt limit, objective auto-grading, dan audit. Lecturer builder serta manual essay grading belum lengkap. |
