...
| Grades, KHS, GPA, transcript | PARTIAL | 84% | Ya | Ya | GradeCalculator + workflow | Role/service guard | Tabler approval/publish/lock | KHS/transcript read | Tabler scheme/component/submit | Tidak | Ya | Component score, exact weight, full lock lifecycle, controlled revision, IPS/IPK dan scoped UI tersedia; revision UI, API, repeat policy, PDF/QR masih berikutnya. |
