...
| Student portal | PARTIAL | 68% | Core academic/finance | Ya | Academic record/attendance | Role guard | N/A | Tabler dashboard/KRS/KHS/invoice/attendance | N/A | Read API | Ya | Halaman aktif sudah native Tabler; attendance dan KRS-scoped learning/material/assignment submission tersedia; quiz actions/leave/thesis belum tersedia. |
