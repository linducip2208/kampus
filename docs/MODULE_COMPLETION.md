...
| LMS & assignment | PARTIAL | 62% | Ya | Ya | Submission service | Global | Assignment CRUD | Belum penuh | Belum penuh | Tidak | Ya | Student workspace hanya membuka published content dari kelas KRS; assignment attempt limit, graded lock, resubmit, dan audit tersedia. Lecturer authoring/grading, announcement, discussion, dan private file policy belum lengkap. |
