...
| Lecturer portal | PARTIAL | 82% | Core lecturer/class/LMS | Ya | Workspace/attendance/quiz | Role guard + class ownership | N/A | N/A | Tabler dashboard/schedule/classes/advisees/attendance/LMS/CBT | Lecturer API | Ya | Presensi, grade, LMS authoring/grading, question bank, quiz builder, attempt review, dan manual essay grading tersedia; KRS approval/thesis belum tersedia. |
