...
| Student portal | PARTIAL | 55% | Core academic/finance | Ya | Academic record | Role guard | N/A | Tabler dashboard/KRS/KHS/invoice | N/A | Read API | Ya | Halaman aktif sudah native Tabler; schedule/attendance/LMS/actions/leave/thesis belum tersedia. |
| Lecturer portal | PARTIAL | 50% | Core lecturer/class | Ya | Query workspace | Role guard | N/A | N/A | Tabler dashboard/schedule/classes/advisees | Lecturer API | Ya | Halaman aktif sudah native Tabler; attendance/grade/LMS/KRS approval/thesis belum tersedia. |
