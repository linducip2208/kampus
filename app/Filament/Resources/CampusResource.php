...
abstract class CampusResource extends Resource
{
    public static function getEloquentQuery(): Builder
    {
        ...
        return match (static::getModel()) {
            ...
            \App\Models\InvoiceDiscount::class => $scope->relation($query, $user, 'invoice.enrollment.studyProgram.department.faculty'),
            \App\Models\InvoicePenalty::class => $scope->relation($query, $user, 'invoice.enrollment.studyProgram.department.faculty'),
            \App\Models\PaymentTransaction::class => $scope->direct($query, $user),
            \App\Models\Applicant::class => $scope->direct($query, $user),
            \App\Models\ScholarshipPeriod::class => $scope->relation($query, $user, 'scholarship'),
            \App\Models\GraduationPeriod::class => $scope->direct($query, $user),
            \App\Models\Company::class => $scope->direct($query, $user),
            \App\Models\TracerSection::class => $scope->direct($query, $user),
