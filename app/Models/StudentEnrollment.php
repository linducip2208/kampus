...
class StudentEnrollment extends CampusModel
{
    ...
    public function advisor() { return $this->belongsTo(LecturerProfile::class, 'advisor_id'); }
    public function statusHistories() { return $this->hasMany(StudentStatusHistory::class); }
