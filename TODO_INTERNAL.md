...
- LMS data baseline, KRS-scoped student learning workspace, published module/content visibility, assignment attempt limits + audit, QuizAttemptService, dan workflow tests.
...
3. Lengkapi lecturer LMS authoring, assignment grading/file manager, quiz/CBT UI, lalu leave dan workflow portal.
...
- `composer validate`, `migrate:fresh --seed`, Blade cache, 69 tests/255 assertions, scoped Pint, dan Vite production build: PASS (2026-09-15).
