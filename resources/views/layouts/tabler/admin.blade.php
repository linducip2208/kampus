...
@php
    $groups = [
        ...
        'MAHASISWA & PERKULIAHAN' => [
            ...
            ['label'=>'Cuti & Aktif Kembali','icon'=>'ti-user-cog','route'=>'admin.student-lifecycle.index','permission'=>'student_enrollments.view','roles'=>['super_admin','baak']],
            ['label'=>'Siklus Akademik','icon'=>'ti-school','route'=>'admin.academic-lifecycle.index','permission'=>'students.view','roles'=>['super_admin','baak']],
            ['label'=>'Layanan Kampus','icon'=>'ti-books','route'=>'admin.campus-services.index','permission'=>'courses.view','roles'=>['super_admin','baak','perpustakaan','lppm','kemahasiswaan']],
            ['label'=>'Operasional','icon'=>'ti-settings-cog','route'=>'admin.ops.index','permission'=>'student_invoices.view','roles'=>['super_admin','finance','auditor','baak']],
